...
class Login extends React.Component {
  ...
  componentDidMount() {
    ...
    // const param = this.props.match.location.search // '?username=vincentzhao&department=ITD&ssicid=001050908&staffid=01803'
    // const arr = param.split('&') // ['?username=', 'f=7']
    // const usercode = arr[0].substr(10) // '1'
    // const failedCount = arr[1].substr(2) // '7'
    // console.log(usercode);
    // this.autologin(usercode,'');
    // const result = reqLogin(usercode, password)
    ...
    return (
      <div className="login-page">
        ...
        <div className="login-header">
          <div className="logo">
            <img src="/assets/user_location.png" alt="会员管理系统" />
            会员管理系统
          </div>
        </div>
        <div className="login-content-wrap">
          <div className="login-content">
            ...
            <div className="login-box">
              ...
              <div className="title">会员系统欢迎您</div>
              <LoginForm ref="login" />
            </div>
          </div>
        </div>
